...
class AccommodationIntegrationTest {
    ...
    void 입력값에_따른_모든_숙소_조회() {
        given(documentationSpec)
            ...
            .body("accommodations[0].id", equalTo(2))
            .body("accommodations[0].price", equalTo(50000))
            .body("accommodations[1].id", equalTo(3))
            .body("accommodations[1].price", equalTo(30000))
            .body("accommodations[2].id", equalTo(4))
            .body("accommodations[2].price", equalTo(20000));
    }
